...
export const en = {
  ...
  quickStart: {
    ...
    connectBody:
      "Three steps for agents in the terminal, or copy the one-liner; claude.ai takes a custom connector and the phone app inherits it. From then on every memory they write carries their name.",
    connectPaneAgents: "Agents in the terminal",
    connectSteps: [
      "Install the CLI; `memax` lands on PATH",
      "Log in once in the browser",
      "Detects installed agents, configures MCP + hooks + instructions, one key per agent",
    ],
    ...
    rememberBody:
      "Say it wherever you already are. Pick a scene below to see the words; five memories unlock dreaming.",
    rememberDumpLabel: "Save",
    rememberReferLabel: "Ask",
    rememberScenes: {
      agent: {
        label: "In your own agent",
        dump: "Hey, remember: this project uses pnpm, not npm",
        dumpReply: "memax_push ✓",
        refer: "Check memax for my deploy notes first",
        referReply: "memax_recall · 3 hits",
        hint: 'Claude Code, Cursor, Codex, OpenClaw, Muse — any agent with the memax MCP understands "remember this" and "check memax". With hooks, Claude Code brings context on its own.',
      },
      claude: {
        label: "In the Claude app",
        dump: "Save to memax: align the release tomorrow",
        dumpReply: "Saved ✓",
        refer: "What did I say in memax about the last deploy?",
        referReply: "2 memories",
        hint: "Same on claude.ai, desktop and the phone app — connectors are per account. Naming memax tells Claude which tool to reach for.",
      },
      web: {
        label: "On memax.app",
        dump: "",
        ...
        refer: "",
        referReply: "",
        hint: "⌘K or the ✦ box. Paste anything: a wiki page, a link, one line. Questions go in the same box.",
      },
    },
    rememberProgress:
    ...
    kickerAsk: "4 / 6 · Ask",
    askTitle: "Ask memax",
    askBody: "It answers from what you tossed in, with citations.",
    askExampleQ: "What bit us on the last deploy?",
    askExampleA:
      "The worker's 10-minute job timeout was too short; after the DeepSeek switch every merge stage timed out — you raised it to 30 minutes.",
    askExampleCite: "cites · 2 memories",
    askCta: "Ask one",
    kickerDream: "5 / 6 · Dream",
    kickerDreaming: "5 / 6 · Dreaming",
    dreamTitle: "Let memax dream",
    dreamBody:
      "A dream threads your memories together: merges duplicates, finds contradictions, writes the night's notes. The first one takes a minute or two.",
    dreamLocked: "Unlocks after five memories.",
    dreamingTitle: "memax is threading your memories",
    dreamingBody:
      "The first one takes a minute or two. When it lands, this card becomes your first dream note — the pulse page's opening act.",
    ...
    teamBody:
      "Make a team hub and your teammates' agents can recall it too. Who wrote what stays clear. Optional.",
    ...
    useCases: [
      {
        say: "Hey, remember: this project uses pnpm, not npm",
        then: "The agent calls memax_push; every agent remembers next time.",
      },
      {
        say: "Check memax for my deploy notes first",
        then: "The agent calls memax_recall and starts with context.",
      },
      {
        say: "(on the phone) Note that I need to align the release tomorrow",
      ...
      },
      {
        ...
        then: "Teammates' agents can recall it, with clear attribution.",
      },
      {
        say: "(nothing at all)",
        then: "memax dreams every night: merges, finds contradictions, writes the notes — read them on pulse the next day.",
      },
    ],

...
export const en = {
  ...
  board: {
    ...
    customBoardUntitled: "Untitled board",
    kindFilterAll: "All",
    receiptAcked: "Noted",
    ...
    activityPurpose:
      "What landed in the last day, which topic it went to, who wrote it and through which agent — a receipt; tap a row to open that memory.",
    activityUnassigned: "No topic yet",
    activityYou: "You",
